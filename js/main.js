...
const togglePromotionIcon = document.querySelector('.toggle-promotion .material-icons');
...
promotionToggleBtn.addEventListener('click', function(){
    ...
    if(isHidePromotion){
        ...
        togglePromotionIcon.classList.add('rotate');
    }else{
        promotionEl.classList.remove('show');
        togglePromotionIcon.classList.remove('rotate');
    }
});
